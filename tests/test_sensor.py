...
class TestMysaDiagnosticSensorInit:
    ...
    @pytest.mark.asyncio
    async def test_rssi_sensor_init(self, hass, mock_coordinator, mock_device_data, mock_entry):
    ...
    @pytest.mark.asyncio
    async def test_duty_sensor_init(self, hass, mock_coordinator, mock_device_data, mock_entry):
...
class TestMysaDiagnosticSensorValues:
    ...
    def create_sensor(self, hass, mock_coordinator, mock_device_data, mock_entry):
        ...
        def _create(sensor_key, name_suffix, unit=None, state_class=None, device_class=None):
...
class TestMysaZoneSensor:
    ...
    @pytest.mark.asyncio
    async def test_zone_sensor_value(self, hass, mock_coordinator, mock_device_data, mock_api):
    ...
    @pytest.mark.asyncio
    async def test_zone_sensor_device_info(self, hass, mock_coordinator, mock_device_data, mock_api):
    ...
    @pytest.mark.asyncio
    async def test_zone_sensor_extra_attributes(self, hass, mock_coordinator, mock_device_data, mock_api):
...
class TestMysaSimulatedCurrentSensor:
    ...
    @pytest.mark.asyncio
    async def test_simulated_current_init(self, hass, mock_coordinator, mock_lite_device_data, mock_entry):
    ...
    @pytest.mark.asyncio
    async def test_simulated_current_value(self, hass, mock_coordinator, mock_lite_device_data, mock_entry):
    ...
    @pytest.mark.asyncio
    async def test_simulated_current_device_info(self, hass, mock_coordinator, mock_lite_device_data, mock_entry):
    ...
    @pytest.mark.asyncio
    async def test_simulated_current_extra_attrs(self, hass, mock_coordinator, mock_lite_device_data, mock_entry):
...
class TestMysaSimulatedPowerSensor:
    ...
    @pytest.mark.asyncio
    async def test_simulated_power_init(self, hass, mock_coordinator, mock_lite_device_data, mock_entry):
    ...
    @pytest.mark.asyncio
    async def test_simulated_power_value(self, hass, mock_coordinator, mock_lite_device_data, mock_entry):
    ...
    @pytest.mark.asyncio
    async def test_simulated_power_device_info(self, hass, mock_coordinator, mock_lite_device_data, mock_entry):
    ...
    @pytest.mark.asyncio
    async def test_simulated_power_extra_attrs(self, hass, mock_coordinator, mock_lite_device_data, mock_entry):
...
class TestSensorSetup:
    ...
    @pytest.mark.asyncio
    async def test_async_setup_entry_creates_sensors(self, hass, mock_coordinator, mock_api, mock_entry):
    ...
    @pytest.mark.asyncio
    async def test_async_setup_entry_heating_sensors(self, hass, mock_coordinator, mock_entry):
        """Test setup creates heating-specific sensors."""
        from custom_components.mysa.sensor import async_setup_entry, MysaDiagnosticSensor
    ...
    @pytest.mark.asyncio
    async def test_async_setup_entry_lite_simulated_sensors(self, hass, mock_coordinator, mock_entry):
        """Test setup creates simulated sensors for Lite devices."""
        from custom_components.mysa.sensor import async_setup_entry, MysaSimulatedCurrentSensor, MysaSimulatedPowerSensor
        ...
        mock_api = MagicMock()
        mock_api.get_devices = AsyncMock(return_value={
            "lite_device": {"Id": "lite_device", "Name": "Lite", "Model": "BB-V2-0-L"}
        })
        mock_api.is_ac_device = MagicMock(return_value=False)
    ...
    @pytest.mark.asyncio
    async def test_async_setup_entry_ac_skips_heating_sensors(self, hass, mock_coordinator, mock_entry):
...
class TestSensorEdgeCases:
    ...
    async def test_diagnostic_sensor_duty_normalization(self, hass, mock_entry):
        ...
        device_data = {"Id": "device1", "Name": "Test", "Model": "BB-V2"}
        entity = MysaDiagnosticSensor(coordinator, "device1", device_data, "Duty", "Duty Cycle", "%", None, None, mock_entry)
    ...
    async def test_simulated_current_calculation(self, hass, mock_entry):
        ...
        entity = MysaSimulatedCurrentSensor(coordinator, "device1", device_data, 15.0, mock_entry)
    ...
    async def test_simulated_power_calculation(self, hass, mock_entry):
        ...
        device_data = {"Id": "device1", "Name": "Test", "Model": "BB-V2-L"}
        entity = MysaSimulatedPowerSensor(coordinator, "device1", device_data, 15.0, mock_entry)
...
class TestSensorFinalEdgeCases:
    ...
    async def test_diagnostic_sensor_zone_name_present(self, hass, mock_entry):
        ...
        device_data = {"Id": "device1", "Name": "Test", "Model": "BB-V2"}
        entity = MysaDiagnosticSensor(coordinator, "device1", device_data, "Rssi", "RSSI", "dBm", None, None, entry)
    ...
    async def test_diagnostic_sensor_no_state(self, hass, mock_entry):
        ...
        device_data = {"Id": "device1", "Name": "Test", "Model": "BB-V2"}
        entity = MysaDiagnosticSensor(coordinator, "device1", device_data, "Rssi", "RSSI", "dBm", None, None, mock_entry)
    ...
    async def test_diagnostic_sensor_value_error(self, hass, mock_entry):
        ...
        device_data = {"Id": "device1", "Name": "Test", "Model": "BB-V2"}
        entity = MysaDiagnosticSensor(coordinator, "device1", device_data, "TimeZone", "Time Zone", None, None, None, mock_entry)
    ...
    async def test_extract_value_dict_id_fallback(self, hass, mock_entry):
        ...
        device_data = {"Id": "device1", "Name": "Test", "Model": "BB-V2"}
        entity = MysaDiagnosticSensor(coordinator, "device1", device_data, "Zone", "Zone", None, None, None, mock_entry)
    ...
    async def test_simulated_power_dict_voltage(self, hass, mock_entry):
        ...
        async def async_update():
            return {"device1": {"Duty": 50, "Voltage": {"v": 220}}}  # Dict format voltage
        coordinator = DataUpdateCoordinator(hass, MagicMock(), name="test", update_method=async_update)
        await coordinator.async_refresh()
...
class TestSensorFinalCoverage:
    ...
    async def test_diagnostic_sensor_value_error_exception(self, hass, mock_entry):
        ...
        async def async_update():
            return {"device1": {"CustomKey": [1, 2, 3]}}  # List cannot be converted to float
        coordinator = DataUpdateCoordinator(hass, MagicMock(), name="test", update_method=async_update)
        await coordinator.async_refresh()
        
        device_data = {"Id": "device1", "Name": "Test", "Model": "BB-V2"}
        entity = MysaDiagnosticSensor(coordinator, "device1", device_data, "CustomKey", "Custom", None, None, None, mock_entry)
    ...
    async def test_diagnostic_sensor_key_not_found(self, hass, mock_entry):
        ...
        async def async_update():
            return {"device1": {"OtherKey": 123}}  # State exists but sensor key not found
        coordinator = DataUpdateCoordinator(hass, MagicMock(), name="test", update_method=async_update)
        await coordinator.async_refresh()
        
        device_data = {"Id": "device1", "Name": "Test", "Model": "BB-V2"}
        entity = MysaDiagnosticSensor(coordinator, "device1", device_data, "Rssi", "RSSI", None, None, None, mock_entry)
