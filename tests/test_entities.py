...
def mock_coordinator(hass):
    ...
    return DataUpdateCoordinator(hass, MagicMock(), name="test", update_method=async_update)


@pytest.fixture
def mock_device_data():
    """Mock device data."""
    return {"Id": "device1", "Name": "Living Room", "Model": "BB-V2", "FirmwareVersion": "1.2.3"}
...
def mock_api():
    ...
    api.devices = {
        "device1": {"Id": "device1", "Name": "Living Room", "Model": "BB-V2", "FirmwareVersion": "1.0.0"},
    }
...
class TestMinBrightnessNumber:
    ...
    @pytest.mark.asyncio
    async def test_native_value(self, hass, mock_coordinator, mock_device_data, mock_api, mock_entry):
    ...
    @pytest.mark.asyncio
    async def test_set_native_value(self, hass, mock_coordinator, mock_device_data, mock_api, mock_entry):
    ...
    @pytest.mark.asyncio
    async def test_device_info(self, hass, mock_coordinator, mock_device_data, mock_api, mock_entry):
...
class TestLockSwitch:
    ...
    @pytest.mark.asyncio
    async def test_is_on(self, hass, mock_coordinator, mock_device_data, mock_api, mock_entry):
        """Test is_on property."""
    ...
    @pytest.mark.asyncio
    async def test_turn_on(self, hass, mock_coordinator, mock_device_data, mock_api, mock_entry):
        """Test turn_on action."""
        from custom_components.mysa.switch import MysaLockSwitch
    ...
    @pytest.mark.asyncio
    async def test_turn_off(self, hass, mock_coordinator, mock_device_data, mock_api, mock_entry):
...
class TestClimatePlusSwitch:
    ...
    @pytest.mark.asyncio
    async def test_turn_on(self, hass, mock_coordinator, mock_ac_device_data, mock_api, mock_entry):
        """Test turn_on action."""
    ...
    @pytest.mark.asyncio
    async def test_turn_off(self, hass, mock_coordinator, mock_ac_device_data, mock_api, mock_entry):
        """Test turn_off action."""
        from custom_components.mysa.switch import MysaClimatePlusSwitch
...
class TestSelectSetup:
    ...
    async def test_async_setup_entry_with_ac(self, hass, mock_entry):
        ...
        mock_api.get_devices = AsyncMock(return_value={
            "ac_device": {"Id": "ac_device", "Name": "AC", "Model": "AC-V1", "SupportedCaps": {}}
        })
...
class TestHorizontalSwingSelect:
    ...
    @pytest.mark.asyncio
    async def test_options(self, hass, mock_coordinator, mock_ac_device_data, mock_api, mock_entry):
        """Test options property."""
        from custom_components.mysa.select import MysaHorizontalSwingSelect
        
        await mock_coordinator.async_refresh()
        entity = MysaHorizontalSwingSelect(mock_coordinator, "ac_device", mock_ac_device_data, mock_api, mock_entry)
        
        assert isinstance(entity.options, list)
        assert len(entity.options) > 0

    @pytest.mark.asyncio
    async def test_current_option(self, hass, mock_coordinator, mock_ac_device_data, mock_api, mock_entry):
    ...
    @pytest.mark.asyncio
    async def test_select_option(self, hass, mock_coordinator, mock_ac_device_data, mock_api, mock_entry):
    ...
    @pytest.mark.asyncio
    async def test_select_unknown_option(self, hass, mock_coordinator, mock_ac_device_data, mock_api, mock_entry):
    ...
    @pytest.mark.asyncio
    async def test_device_info(self, hass, mock_coordinator, mock_ac_device_data, mock_api, mock_entry):
        """Test device_info property."""
        from custom_components.mysa.select import MysaHorizontalSwingSelect
...
class TestMysaUpdate:
    ...
    async def test_init(self, hass, mock_api):
        ...
        device_data = {"Id": "device1", "Name": "Living Room", "Model": "BB-V2", "FirmwareVersion": "1.2.3"}
    ...
    async def test_async_update_success(self, hass, mock_api):
        ...
        mock_api.hass = hass
        mock_api.fetch_firmware_info = MagicMock(return_value={
...
class TestNumberEdgeCases:
    ...
    @pytest.mark.asyncio
    async def test_device_info_with_zone_name(self, hass, mock_coordinator_with_zone, mock_device_data, mock_api):
        ...
        entity = MysaMinBrightnessNumber(mock_coordinator_with_zone, "device1", mock_device_data, mock_api, entry)
        
        info = entity.device_info
        assert info.get("suggested_area") == "Living Room Zone"

    @pytest.mark.asyncio
    async def test_extract_value_with_id_key(self, hass, mock_coordinator, mock_device_data, mock_api, mock_entry):
    ...
    async def test_pending_expired(self, hass, mock_device_data, mock_api, mock_entry):
        ...
        coordinator = DataUpdateCoordinator(hass, MagicMock(), name="test", update_method=async_update)
        await coordinator.async_refresh()
        
        entity = MysaMinBrightnessNumber(coordinator, "device1", mock_device_data, mock_api, mock_entry)
    ...
    @pytest.mark.asyncio
    async def test_no_state_returns_none(self, hass, mock_device_data, mock_api, mock_entry):
...
class TestSwitchEdgeCases:
    ...
    @pytest.mark.asyncio
    async def test_device_info_with_zone_name(self, hass, mock_coordinator, mock_device_data, mock_api):
        """Test device_info includes zone name when configured."""
        from custom_components.mysa.switch import MysaLockSwitch
        ...
        entity = MysaLockSwitch(mock_coordinator, "device1", mock_device_data, mock_api, entry)
    ...
    @pytest.mark.asyncio
    async def test_pending_state_on_no_data(self, hass, mock_device_data, mock_api, mock_entry):
        ...
        entity = MysaLockSwitch(coordinator, "device1", mock_device_data, mock_api, mock_entry)
        entity._pending_state = True
        
        assert entity.is_on is True

    @pytest.mark.asyncio
    async def test_pending_cleared_on_confirmed(self, hass, mock_coordinator, mock_device_data, mock_api, mock_entry):
...
class TestSelectEdgeCases:
    ...
    @pytest.mark.asyncio
    async def test_device_info_with_zone_name(self, hass, mock_coordinator, mock_ac_device_data, mock_api):
        """Test device_info includes zone name when configured."""
        from custom_components.mysa.select import MysaHorizontalSwingSelect
        ...
        entity = MysaHorizontalSwingSelect(mock_coordinator, "ac_device", mock_ac_device_data, mock_api, entry)
        
        info = entity.device_info
        assert info.get("suggested_area") == "Bedroom Zone"

    @pytest.mark.asyncio
    async def test_current_option_with_dict_value(self, hass, mock_ac_device_data, mock_api, mock_entry):
        ...
        entity = MysaHorizontalSwingSelect(coordinator, "ac_device", mock_ac_device_data, mock_api, mock_entry)
        
        option = entity.current_option
        assert option is not None

    @pytest.mark.asyncio
    async def test_pending_cleared_on_confirmed(self, hass, mock_coordinator, mock_ac_device_data, mock_api, mock_entry):
    ...
    @pytest.mark.asyncio
    async def test_select_option_exception(self, hass, mock_coordinator, mock_ac_device_data, mock_entry):
...
class TestFinalEdgeCases:
    ...
    @pytest.mark.asyncio
    async def test_number_pending_valid(self, hass, mock_device_data, mock_api, mock_entry):
    ...
    @pytest.mark.asyncio
    async def test_number_extract_value_none(self, hass, mock_coordinator, mock_device_data, mock_api, mock_entry):
    ...
    @pytest.mark.asyncio
    async def test_select_no_state_returns_auto(self, hass, mock_ac_device_data, mock_api, mock_entry):
    ...
    @pytest.mark.asyncio
    async def test_select_no_swing_value_returns_auto(self, hass, mock_ac_device_data, mock_api, mock_entry):
    ...
    @pytest.mark.asyncio
    async def test_switch_extract_value_none(self, hass, mock_coordinator, mock_device_data, mock_api, mock_entry):
        """Test _extract_value returns None when key not found."""
        from custom_components.mysa.switch import MysaLockSwitch
    ...
    @pytest.mark.asyncio
    async def test_switch_pending_fallback_when_val_none(self, hass, mock_device_data, mock_api, mock_entry):
    ...
    @pytest.mark.asyncio
    async def test_auto_brightness_is_on(self, hass, mock_coordinator, mock_device_data, mock_api, mock_entry):
    ...
    @pytest.mark.asyncio
    async def test_proximity_is_on(self, hass, mock_coordinator, mock_device_data, mock_api, mock_entry):
    ...
    @pytest.mark.asyncio
    async def test_climate_plus_is_on(self, hass, mock_coordinator, mock_ac_device_data, mock_api, mock_entry):
...
class TestMysaNumberEntities:
    ...
    @pytest.mark.asyncio
    async def test_min_brightness_number_init(self, hass, mock_coordinator, mock_device_data, mock_api, mock_entry):
    ...
    @pytest.mark.asyncio
    async def test_min_brightness_native_value(self, hass, mock_coordinator, mock_device_data, mock_api, mock_entry):
    ...
    @pytest.mark.asyncio
    async def test_min_brightness_set_value(self, hass, mock_coordinator, mock_device_data, mock_api, mock_entry):
    ...
    @pytest.mark.asyncio
    async def test_max_brightness_number_init(self, hass, mock_coordinator, mock_device_data, mock_api, mock_entry):
    ...
    @pytest.mark.asyncio
    async def test_max_brightness_set_value(self, hass, mock_coordinator, mock_device_data, mock_api, mock_entry):
...
class TestMysaSwitchEntities:
    ...
    @pytest.mark.asyncio
    async def test_lock_switch_init(self, hass, mock_coordinator, mock_device_data, mock_api, mock_entry):
    ...
    @pytest.mark.asyncio
    async def test_lock_switch_is_on(self, hass, mock_coordinator, mock_device_data, mock_api, mock_entry):
    ...
    @pytest.mark.asyncio
    async def test_lock_switch_turn_on(self, hass, mock_coordinator, mock_device_data, mock_api, mock_entry):
    ...
    @pytest.mark.asyncio
    async def test_lock_switch_turn_off(self, hass, mock_coordinator, mock_device_data, mock_api, mock_entry):
    ...
    @pytest.mark.asyncio
    async def test_auto_brightness_switch_init(self, hass, mock_coordinator, mock_device_data, mock_api, mock_entry):
    ...
    @pytest.mark.asyncio
    async def test_proximity_switch_init(self, hass, mock_coordinator, mock_device_data, mock_api, mock_entry):
    ...
    @pytest.mark.asyncio
    async def test_climate_plus_switch_init(self, hass, mock_coordinator, mock_device_data, mock_api, mock_entry):
...
class TestMysaSelectEntities:
    ...
    @pytest.mark.asyncio
    async def test_horizontal_swing_select_init(self, hass, mock_coordinator, mock_device_data, mock_api, mock_entry):
    ...
    @pytest.mark.asyncio
    async def test_horizontal_swing_options(self, hass, mock_coordinator, mock_device_data, mock_api, mock_entry):
    ...
    @pytest.mark.asyncio
    async def test_horizontal_swing_current_option(self, hass, mock_coordinator, mock_device_data, mock_api, mock_entry):
    ...
    @pytest.mark.asyncio
    async def test_horizontal_swing_select_option(self, hass, mock_coordinator, mock_device_data, mock_api, mock_entry):
...
class TestMysaSensorEntities:
    ...
    @pytest.mark.asyncio
    async def test_diagnostic_sensor_init(self, hass, mock_coordinator, mock_device_data, mock_api, mock_entry):
    ...
    @pytest.mark.asyncio
    async def test_diagnostic_sensor_value(self, hass, mock_coordinator, mock_device_data, mock_api, mock_entry):
    ...
    @pytest.mark.asyncio
    async def test_zone_sensor_init(self, hass, mock_coordinator, mock_device_data, mock_api):
    ...
    @pytest.mark.asyncio
    async def test_simulated_current_sensor_init(self, hass, mock_coordinator, mock_device_data, mock_entry):
    ...
    @pytest.mark.asyncio
    async def test_simulated_power_sensor_init(self, hass, mock_coordinator, mock_device_data, mock_entry):
...
class TestStateAssertions:
    ...
    async def test_state_attributes(self, hass):
        ...
        hass.states.async_set("sensor.mysa_temp", "21.5", {
