...
class TestCognitoClass:
    ...
    def test_cognito_init(self):
        ...
        from custom_components.mysa.mysa_auth import Cognito, USER_POOL_ID, CLIENT_ID, JWKS
...
class TestGetCredentials:
    ...
    def test_get_credentials_requires_id(self):
        ...
        with patch('pycognito.Cognito.__init__', return_value=None):
            ...
            with pytest.raises(ValueError, match="Either identity_pool_id or identity_id"):
                cog.get_credentials()

    def test_get_credentials_with_identity_pool(self):
        """Test get_credentials with identity pool ID."""
        from custom_components.mysa.mysa_auth import Cognito, USER_POOL_ID, CLIENT_ID, IDENTITY_POOL_ID
        ...
        with patch('pycognito.Cognito.__init__', return_value=None):
            ...
            mock_client.get_id.return_value = {"IdentityId": "us-east-1:mock-identity-id"}
    ...
    def test_get_credentials_with_session_client(self):
        ...
        with patch('pycognito.Cognito.__init__', return_value=None):
            ...
            mock_session.client.assert_called_with('cognito-identity', region_name='us-east-1')
